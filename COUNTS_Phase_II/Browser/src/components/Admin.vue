  ...
  export default {
    ...
    methods: {
      ...
      drawWorkerNum() {
        ...
        xmlhttp.open('GET', 'http://106.14.188.84:8080/counts/analysis/levelchart/worker', false);
      ...
      drawRequstorNum() {
        ...
        xmlhttp.open('GET', 'http://106.14.188.84:8080/counts/analysis/levelchart/requestor', false);
        xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf-8");
        xmlhttp.send(null);
      ...
      drawUserNum() {
        ...
        xmlhttp.open('GET','http://106.14.188.84:8080/counts/analysis/getnumber/requestor',false);
        xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf-8");
        xmlhttp.send(null);
        ...
        xmlhttp.open('GET','http://106.14.188.84:8080/counts/analysis/getnumber/worker',false);
        xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf-8");
        xmlhttp.send(null);
      ...
      drawMissionNum() {
        ...
        xmlhttp.open('GET', 'http://106.14.188.84:8080/counts/analysis/getmission/monthcart', false);
        xmlhttp.setRequestHeader("Content-type", "application/json; charset=utf-8");
        xmlhttp.send(null);
