...
export default {
  ...
  methods: {
    ...
    login: function () {
      ...
      xmlhttp.open('POST', 'http://106.14.188.84:8080/counts/user/signin', true)
    ...
    toUserPage () {
      ...
      xmlhttp2.open('POST', 'http://106.14.188.84:8080/counts/user/findusername', true)
    ...
    handleRegister: function () {
      ...
      if (password != checkPassword) {
        ...
        xmlhttp.open('POST', 'http://106.14.188.84:8080/counts/user/signup', true)
        xmlhttp.setRequestHeader('Content-type', 'application/json; charset=utf-8')
        xmlhttp.send(JSON.stringify(user))
      }
